...
$(document).scroll(function () {
  ...
  if (y > 4200 && y < 4500) {
    ...
    $('.scale .scale-line').css({
      'background-position-y': '-1359.5px',
      'transition': '1s'
    });
    $('.label li').removeClass('active');
    $('.label li:nth-child(2)').addClass('active');
  ...
  if (y > 4500 && y < 4800) {
    ...
    $('.scale .scale-line').css({
      'background-position-y': '-1464.1px',
      'transition': '1s'
    });
    $('.arrow').css({
      'top': '54.1%'
  ...
  if (y > 4800 && y < 5100) {
    ...
    $('.header-box').hide(400);
    $('.scale .scale-line').css({
      'background-position-y': '-1566.1px',
      'transition': '1s'
    });
    $('.arrow').css({
      'top': '54.1%'
  ...
  if (y > 6600 && y < 6900) {
    ...
    $('.header-box').hide(400);
    $('.scale .scale-line').css({
      'background-position-y': '-2219.5px',
      'transition': '1s'
    });
    $('.arrow').css({
      'top': '62.1%'
  ...
  if (y > 6900 && y < 7200) {
    ...
    $('.scale .scale-line').css({
      'background-position-y': '-2323.5px',
      'transition': '1s'
    });
    $('.arrow').css({
      'top': '62.1%'
  ...
  if (y > 7200 && y < 7500) {
    ...
    $('.header-box').hide(400);
    $('.scale .scale-line').css({
      'background-position-y': '-2416.5px',
      'transition': '1s'
    });
    $('.arrow').css({
      'top': '62.1%'
