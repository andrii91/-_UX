 ...
 var scalePosition;
    ...
    $(document).scroll(function() {
        ...
        if (y > 300 && y < 600) {
            ...
            // scalePosition = parseInt($('.scale .scale-line').css('background-position-y')) - 17.3;
